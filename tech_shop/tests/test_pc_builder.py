...
class TestPCBuilderService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.db.execute("INSERT INTO categories VALUES (1, 'Бытовая техника')")
        self.db.execute("INSERT INTO categories VALUES (2, 'Комплектующие для ПК')")
        self.db.execute("INSERT INTO categories VALUES (3, 'Ноутбуки и планшеты')")
        self.db.execute("INSERT INTO categories VALUES (4, 'Аксессуары')")
        self.db.execute("INSERT INTO categories VALUES (5, 'Периферия')")
        ...
        self.db.execute("""
            INSERT INTO producrs 
            (id_product, name_of_product, price, id_category, quantity_at_storage) 
            VALUES (28, 'SSD накопитель Samsung 500GB', 6500.0, 2, 25)""")
        
        self.db.execute("""
            INSERT INTO producrs 
            (id_product, name_of_product, price, id_category, quantity_at_storage) 
            VALUES (30, 'HDD Seagate 2TB', 5900.0, 2, 15)""")
