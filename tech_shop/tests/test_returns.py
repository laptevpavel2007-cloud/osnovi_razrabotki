...
class TestReturns(unittest.TestCase):
    def setUp(self):
        ...
        self.receipt = self.receipt_service.create_receipt(1, [(1, 'Product', 2, 100.0, 200.0)])
        cursor = self.db.execute("SELECT id_sale FROM sale_items WHERE id_check = ?",(self.receipt['id'],))
    ...
    def test_get_available(self):
        items = self.service.get_available_for_return(self.receipt['id'])
    ...
    def test_process_return(self):
        ...
        self.assertEqual(product.quantity, 11)
